#taking input value  of the range from user
...
# if the value of l is an even number then only l is added with the total variable.
 if l%2==0:
# after every cycle of the loop the value of l is added with total .
    total+=l
print(f"SUM  OF THE ALL EVEN NUMBER BETWEEN {start} and {end} is:={total}")